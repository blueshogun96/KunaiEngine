...
#ifndef NV_FOUNDATION_USE_F64

	typedef float						NvReal;

	#define	NV_MAX_REAL					NV_MAX_F32
	#define NV_EPS_REAL					NV_EPS_F32
	#define NV_NORMALIZATION_EPSILON	NvReal(1e-20f)

#else

	typedef double						NvReal;

	#define	NV_MAX_REAL					NV_MAX_F64
	#define NV_EPS_REAL					NV_EPS_F64
	#define NV_NORMALIZATION_EPSILON	NvReal(1e-180)
