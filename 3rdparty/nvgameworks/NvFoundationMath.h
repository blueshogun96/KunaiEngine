...
//***************************************
	...
	static const NvReal NvInvTwoPi		=   NvReal(0.15915494309189533577);
	static const NvReal NvPiDivTwo		=   NvReal(1.57079632679489661923);
	static const NvReal NvPiDivFour		=   NvReal(0.78539816339744830962);
...
public:
	...
	*/
	explicit NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec2(NvReal a): x(a), y(a) {}
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec2(NvReal nx, NvReal ny): x(nx), y(ny){}
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal& operator[](int index)
	{
		NV_ASSERT(index>=0 && index<=1);

		return reinterpret_cast<NvReal*>(this)[index];
	}

	/**
	\brief element access
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE const NvReal& operator[](int index) const
	{
		NV_ASSERT(index>=0 && index<=1);

		return reinterpret_cast<const NvReal*>(this)[index];
	}
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal magnitudeSquared() const		{	return x * x + y * y;					}

	/**
	\brief returns the magnitude
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal magnitude() const				{	return NvSqrt(magnitudeSquared());		}
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec2 operator *(NvReal f) const				{	return NvVec2(x * f, y * f);			}

	/**
	\brief scalar division
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec2 operator /(NvReal f) const
	{
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec2& operator *=(NvReal f)
	{
		x *= f;
		y *= f;
		return *this;
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal dot(const NvVec2& v) const		
	{
		return x * v.x + y * v.y;				
	}
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal normalize()
	{
...
NV_CUDA_CALLABLE static NV_FORCE_INLINE NvVec2 operator *(NvReal f, const NvVec2& v)
{
...
public:
	...
	*/
	...
	\param[in] a Value to assign to elements.
	*/
	explicit NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec3(NvReal a): x(a), y(a), z(a) {}
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec3(NvReal nx, NvReal ny, NvReal nz): x(nx), y(ny), z(nz) {}
	...
	*/
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal& operator[](unsigned int index)
	{
		NV_ASSERT(index<=2);
	...
	*/
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE const NvReal& operator[](unsigned int index) const
	{
		NV_ASSERT(index<=2);
	...
	*/
	...
	Avoids calling NvSqrt()!
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal magnitudeSquared() const		{	return x * x + y * y + z * z;					}
	...
	*/
	...
	\brief scalar post-multiplication
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec3 operator *(NvReal f) const				{	return NvVec3(x * f, y * f, z * f);			}

	/**
	\brief scalar division
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec3 operator /(NvReal f) const
	{
		f = 1.0f / f;
	...
	*/
	...
	\brief scalar multiplication
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvVec3& operator *=(NvReal f)
	{
		x *= f;
		y *= f;
		z *= f;
	...
	*/
	...
	\brief returns the scalar product of this and other.
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal dot(const NvVec3& v) const		
	{	
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal normalizeSafe()
	{
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal normalizeFast()
	{
		const NvReal mag = magnitude();
...
NV_CUDA_CALLABLE static NV_FORCE_INLINE NvVec3 operator *(NvReal f, const NvVec3& v)
{
...
public:
	...
	*/
	...
	\param[in] a Value to assign to elements.
	*/
	explicit NV_CUDA_CALLABLE NV_INLINE NvVec4(NvReal a): x(a), y(a), z(a), w(a) {}
	...
	*/
	NV_CUDA_CALLABLE NV_INLINE NvVec4(NvReal nx, NvReal ny, NvReal nz, NvReal nw): x(nx), y(ny), z(nz), w(nw) {}
	...
	\param[in] nw Value to initialize W component.
	*/
	NV_CUDA_CALLABLE NV_INLINE NvVec4(const NvVec3& v, NvReal nw): x(v.x), y(v.y), z(v.z), w(nw) {}
	...
	*/
	explicit NV_CUDA_CALLABLE NV_INLINE NvVec4(const NvReal v[]): x(v[0]), y(v[1]), z(v[2]), w(v[3]) {}
	...
	*/
	...
	\brief element access
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal& operator[](int index)
	{
	...
	NV_CUDA_CALLABLE NV_INLINE NvReal& operator[](unsigned int index)
	{
		NV_ASSERT(index<=3);
	...
	\brief element access
	*/
	NV_CUDA_CALLABLE NV_INLINE const NvReal& operator[](int index) const
	{
		NV_ASSERT(index>=0 && index<=3);

		return reinterpret_cast<const NvReal*>(this)[index];
	}
	NV_CUDA_CALLABLE NV_INLINE const NvReal& operator[](unsigned int index) const
	{
		NV_ASSERT(index<=3);
	...
	*/
	...
	Avoids calling NvSqrt()!
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal magnitudeSquared() const		{	return x * x + y * y + z * z + w * w;		}

	/**
	\brief returns the magnitude
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal magnitude() const				{	return NvSqrt(magnitudeSquared());		}
	...
	*/
	...
	NV_CUDA_CALLABLE NV_INLINE NvVec4 operator *(NvReal f) const				{	return NvVec4(x * f, y * f, z * f, w * f);		}

	/**
	\brief scalar division
	*/
	NV_CUDA_CALLABLE NV_INLINE NvVec4 operator /(NvReal f) const
	{
		f = 1.0f / f; 
	...
	*/
	...
	\brief scalar multiplication
	*/
	NV_CUDA_CALLABLE NV_INLINE NvVec4& operator *=(NvReal f)
	{
		x *= f;
		y *= f;
		z *= f;
	...
	*/
	...
	\brief returns the scalar product of this and other.
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal dot(const NvVec4& v) const		
	{	
	...
	\brief normalizes the vector in place
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal normalize()
	{
		NvReal m = magnitude();
		if (m>0.0f) 
			*this /= m;
...
NV_CUDA_CALLABLE static NV_INLINE NvVec4 operator *(NvReal f, const NvVec4& v)
{
...
public:
	...
	*/
	explicit NV_CUDA_CALLABLE NV_FORCE_INLINE NvQuat(NvReal r)
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvQuat(NvReal nx, NvReal ny, NvReal nz, NvReal nw) : x(nx),y(ny),z(nz),w(nw) {}
	...
	<b>Unit:</b> Radians
	*/
	NV_CUDA_CALLABLE NV_INLINE NvQuat(NvReal angleRadians, const NvVec3& unitAxis)
	{
	...
	*/
	...
	{
		const NvReal unitTolerance = 1e-4f;
		return isFinite() && NvAbs(magnitude()-1)<unitTolerance;
	}
	...
	*/
	...
	{
	      const NvReal unitTolerance = 1e-2f;
	      return isFinite() && NvAbs(magnitude()-1)<unitTolerance;
	}
	...
	*/
	...
	NV_CUDA_CALLABLE NV_INLINE void toRadiansAndUnitAxis(NvReal& angle, NvVec3& axis) const
	{
		const NvReal quatEpsilon = 1.0e-8f;
	...
	<b>Unit:</b> Radians
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal getAngle() const
	{
	...
	<b>Unit:</b> Radians
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal getAngle(const NvQuat& q) const
	{
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal magnitudeSquared() const
	{
	...
	\brief returns the scalar product of this and other.
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal dot(const NvQuat& v) const
	{
		return x * v.x + y * v.y + z * v.z  + w * v.w;
	}
	...
	*/
	NV_CUDA_CALLABLE NV_INLINE NvReal normalize()											// convert this NvQuat to a unit quaternion
	{
		const NvReal mag = magnitude();
		if (mag)
		{
			const NvReal imag = 1.0f / mag;
...
//		return (v*(w*w-0.5f) - (qv.cross(v))*w + qv*(qv.dot(v)))*2;
	...
	*/
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvQuat& operator*= (const NvReal s)
	{
		x*=s;
		y*=s;
		z*=s;
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvQuat operator*(NvReal r) const
	{
...
public:
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvPlane(NvReal nx, NvReal ny, NvReal nz, NvReal distance)
		: n(nx, ny, nz)
		, d(distance)
	{
	}
	...
	\brief Constructor from a normal and a distance
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvPlane(const NvVec3& normal, NvReal distance) 
		: n(normal)
		, d(distance)
	{
	}
	...
	*/
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal distance(const NvVec3& p) const
	{
		return p.dot(n) + d;
	}
...
#undef invalid
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvTransform(NvReal x, NvReal y, NvReal z, NvQuat aQ = NvQuat(NvIdentity))
		: q(aQ), p(x, y, z)
	{
	}
...
public:
	...
	explicit NV_CUDA_CALLABLE NV_INLINE NvMat33(NvReal r)
		: column0(r,0.0f,0.0f), column1(0.0f,r,0.0f), column2(0.0f,0.0f,r)
	{}


	//! Construct from float[9]
	explicit NV_CUDA_CALLABLE NV_INLINE NvMat33(NvReal values[]):
	...
	//! Get determinant
	NV_CUDA_CALLABLE NV_INLINE NvReal getDeterminant() const
	{
	...
	NV_CUDA_CALLABLE NV_INLINE NvMat33 operator*(NvReal scalar) const
	{
		return NvMat33(column0*scalar, column1*scalar, column2*scalar);
	}

	friend NvMat33 operator*(NvReal, const NvMat33&);
	...
	NV_CUDA_CALLABLE NV_INLINE NvMat33& operator*=(NvReal scalar)
	{
		column0 *= scalar;
		column1 *= scalar;
		column2 *= scalar;
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal operator()(unsigned int row, unsigned int col) const
	{
		return (*this)[col][row];
	}

	//! Element access, mathematical way!
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal& operator()(unsigned int row, unsigned int col)
	{
		return (*this)[col][row];
	}
	...
	NV_CUDA_CALLABLE NV_FORCE_INLINE const NvReal* front() const
	{
		return &column0.x;
	}
...
public:
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal getCenter(uint32_t axis)	const;

	/**
	\brief get component of the box's extents along a given axis
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal getExtents(uint32_t axis)	const;
	...
	*/
	...
	This version is safe to call for empty bounds.
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE void fattenSafe(NvReal distance);
	...
	*/
	NV_CUDA_CALLABLE NV_FORCE_INLINE void fattenFast(NvReal distance);
...
NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal NvBounds3::getCenter(uint32_t axis)	const
{
	NV_ASSERT(isValid());
	return (minimum[axis] + maximum[axis]) * 0.5f;
}

NV_CUDA_CALLABLE NV_FORCE_INLINE NvReal NvBounds3::getExtents(uint32_t axis)	const
{
	NV_ASSERT(isValid());
...
NV_CUDA_CALLABLE NV_FORCE_INLINE void NvBounds3::fattenSafe(NvReal distance)
{
	NV_ASSERT(isValid());
	if (!isEmpty())
		fattenFast(distance);
...
NV_CUDA_CALLABLE NV_FORCE_INLINE void NvBounds3::fattenFast(NvReal distance)
{
	NV_ASSERT(isValid());
	minimum.x -= distance;
	minimum.y -= distance;
...
public:
	...
	explicit NV_CUDA_CALLABLE NV_INLINE NvMat44(NvReal r)
	...
	explicit NV_CUDA_CALLABLE NV_INLINE NvMat44(NvReal values[]):
	...
	//! Scalar multiplication
	NV_CUDA_CALLABLE NV_INLINE NvMat44 operator*(NvReal scalar) const
	{
		return NvMat44(column0*scalar, column1*scalar, column2*scalar, column3*scalar);
	}

	friend NvMat44 operator*(NvReal, const NvMat44&);
	...
	//! Equals scalar multiplication
	NV_CUDA_CALLABLE NV_INLINE NvMat44& operator*=(NvReal scalar)
	{
		column0 *= scalar;
		column1 *= scalar;
		column2 *= scalar;
