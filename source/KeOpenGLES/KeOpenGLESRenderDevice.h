//
//  IKeOpenGLESRenderDevice.h
//
//  Created by Shogun3D on 6/18/15.
//  Copyright (c) 2014 Shogun3D. All rights reserved.
//

#ifndef __IKeOpenGLESRenderDevice__
#define __IKeOpenGLESRenderDevice__
 ...
 */
struct IKeOpenGLESConstantBuffer : public IKeConstantBuffer
{
 ...
 */
struct IKeOpenGLESGeometryBuffer : public IKeGeometryBuffer
{
    virtual void Destroy();
 ...
 */
struct IKeOpenGLESGpuProgram : public IKeGpuProgram
{
    virtual void Destroy();
 ...
 */
struct IKeOpenGLESTexture : public IKeTexture
{
    virtual void Destroy();
 ...
 */
struct IKeOpenGLESRenderTarget : public IKeRenderTarget
{
    virtual void Destroy();
 ...
 */
struct IKeOpenGLESPalette : public IKePalette
{
    virtual void Destroy();
};
 ...
 * GPU fence structure 
 */
struct IKeOpenGLESFence : public IKeFence
{
    virtual void Destroy();
 ...
 */
struct IKeOpenGLESStateBuffer : public IKeStateBuffer
{
    virtual void Destroy();
 ...
 */
class IKeOpenGLESRenderDevice : public IKeRenderDevice
{
public:
    IKeOpenGLESRenderDevice();
    IKeOpenGLESRenderDevice( KeRenderDeviceDesc* renderdevice_desc );
    virtual ~IKeOpenGLESRenderDevice();
 ...
 */
class IKeOpenGLESSpriteFactory : public IKeSpriteFactory
{
public:
    IKeOpenGLESSpriteFactory() {}
    IKeOpenGLESSpriteFactory( IKeRenderDevice* renderdevice, KeVertexAttribute* vertex_attributes, uint32_t batch_size = KE_DEFAULT_BATCH_SIZE );
    virtual ~IKeOpenGLESSpriteFactory();
...
#endif /* defined(__IKeOpenGLESRenderDevice__) */
