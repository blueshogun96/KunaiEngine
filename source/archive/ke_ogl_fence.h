 ...
 */
bool ke_ogl_insert_fence_nv( IKeOpenGLFence** fence )
{
...
bool ke_ogl_test_fence_nv( IKeOpenGLFence* fence )
{
...
void ke_ogl_block_on_fence_nv( IKeOpenGLFence* fence )
{
	glFinishFenceNV( fence->fence );
}

void ke_ogl_delete_fence_nv( IKeOpenGLFence* fence )
{
	glDeleteFencesNV( 1, &fence->fence );
}

bool ke_ogl_is_fence_nv( IKeOpenGLFence* fence )
{
	if( glTestFenceNV( fence->fence ) )
		return true;
 ...
 */
bool ke_ogl_insert_fence_apple( IKeOpenGLFence** fence )
{
	GLenum error = glGetError();
...
bool ke_ogl_test_fence_apple( IKeOpenGLFence* fence )
{
...
void ke_ogl_block_on_fence_apple( IKeOpenGLFence* fence )
{
	glFinishFenceAPPLE( fence->fence );
}

void ke_ogl_delete_fence_apple( IKeOpenGLFence* fence )
{
	glDeleteFencesAPPLE( 1, &fence->fence );
}

bool ke_ogl_is_fence_apple( IKeOpenGLFence* fence )
{
	if( glTestFenceAPPLE( fence->fence ) )
		return true;
 ...
 */
bool ke_ogl_insert_fence_arb( IKeOpenGLFence** fence )
{
	GLenum error = glGetError();
...
bool ke_ogl_test_fence_arb( IKeOpenGLFence* fence )
{
...
void ke_ogl_block_on_fence_arb( IKeOpenGLFence* fence )
{
...
void ke_ogl_delete_fence_arb( IKeOpenGLFence* fence )
{
	glDeleteSync( fence->sync );
}

bool ke_ogl_is_fence_arb( IKeOpenGLFence* fence )
{
...
bool ( *ke_ogl_insert_fence[3] )( IKeOpenGLFence** ) = { ke_ogl_insert_fence_arb, ke_ogl_insert_fence_nv, ke_ogl_insert_fence_apple };
bool ( *ke_ogl_test_fence[3] )( IKeOpenGLFence* ) = { ke_ogl_test_fence_arb, ke_ogl_test_fence_nv, ke_ogl_test_fence_apple };
void ( *ke_ogl_block_on_fence[3] )( IKeOpenGLFence* ) = { ke_ogl_block_on_fence_arb, ke_ogl_block_on_fence_nv, ke_ogl_block_on_fence_apple };
void ( *ke_ogl_delete_fence[3] )( IKeOpenGLFence* ) = { ke_ogl_delete_fence_arb, ke_ogl_delete_fence_nv, ke_ogl_delete_fence_apple };
bool ( *ke_ogl_is_fence[3] )( IKeOpenGLFence* ) = { ke_ogl_is_fence_arb, ke_ogl_is_fence_nv, ke_ogl_is_fence_apple };
