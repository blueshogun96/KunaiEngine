...
#ifndef __ke_ogles2_renderdevice__
#define __ke_ogles2_renderdevice__
 ...
 */
class ke_ogles2_renderdevice_t : public ke_renderdevice_t
{
public:
    ke_ogles2_renderdevice_t();
    ke_ogles2_renderdevice_t( ke_renderdevice_desc_t* renderdevice_desc );
    virtual ~ke_ogles2_renderdevice_t();
...
#endif /* defined(__ke_ogles2_renderdevice__) */
